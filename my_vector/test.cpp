...
void Test3() {
    ...
    {
        Obj::ResetCounters();
        AV_vector<Obj> v_medium(MEDIUM_SIZE);
        v_medium[MEDIUM_SIZE / 2].id = ID;
        AV_vector<Obj> v_large(LARGE_SIZE);
        v_large = v_medium;
    ...
    assert(Obj::GetAliveObjectCount() == 0);
    {
        ...
        AV_vector<Obj> v_small(MEDIUM_SIZE / 2);
...
//        Obj::ResetCounters();
//        AV_vector<Obj> v;
//        auto& elem = v.emplace_back(ID, "Ivan"s);
//        assert(v.capacity() == 1);
//        assert(v.size() == 1);
//        assert(&elem == &v[0]);
//        assert(v[0].id == ID);
...
//        AV_vector<Obj> v{ SIZE };
//        Obj obj{ 1 };
//        AV_vector<Obj>::iterator pos = v.Insert(v.cbegin() + 1, obj);
//        assert(v.size() == SIZE + 1);
//        assert(v.capacity() == SIZE * 2);
//        assert(&*pos == &v[1]);
...
//        Obj::ResetCounters();
//        AV_vector<Obj> v{ SIZE };
//        AV_vector<Obj>::iterator pos = v.Insert(v.cbegin() + 1, Obj{ 1 });
//        assert(v.size() == SIZE + 1);
//        assert(v.capacity() == SIZE * 2);
//        assert(&*pos == &v[1]);
//        assert(v[1].id == 1);
